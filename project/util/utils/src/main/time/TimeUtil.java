...
public class TimeUtil {
    ...
    /**
     * date类型进行格式化输出（返回类型：String HH:mm:ss）
     *
     * @param date
     * @return
     * @author tianyu.tang
    ...
    public static boolean belongCalendar(Date nowTime, String beginTimeStr, String endTimeStr) {
        ...
        String yearAndDay = nowTimeStr.substring(0, 8);
        //设置当前时间
        Calendar date = Calendar.getInstance();
        date.setTime(nowTime);
        //设置开始时间
        beginTimeStr = yearAndDay + " " + beginTimeStr;
        endTimeStr = yearAndDay + " " + endTimeStr;
    ...
    /**
     * 获取传入日期的下一天 日期格式：yyyyMMdd
     *
     * @param strData
     * @return
     */
    public static String getNextDateByDate(String strData) {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
        Date parse = new Date();
        try {
            parse = formatter.parse(strData);
     ...
     * 往前推n月
     */
    public static Date getNextMonth(Date date, Integer s) {
        Calendar instance = Calendar.getInstance();
        instance.setTime(date);
        instance.add(Calendar.MONTH, s);
     ...
     * @throws ParseException
     */
    public static Integer isWeekday(Date date) throws ParseException {
        int result;
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
     ...
     * @return
     */
    public static Integer isBeyondDay(Date date, Integer integer) {
        Calendar instance = Calendar.getInstance();
        instance.setTime(date);
     ...
     * @return
     */
    public static boolean subscribeTime(Long currentTime, Long operTime, String priceFresh) {
        int i = Integer.parseInt(priceFresh);
        long decline = i * 1000;
        return currentTime - operTime > decline;
    }
    /**
     * 功能：  返回"yyyyMMdd"
     *
